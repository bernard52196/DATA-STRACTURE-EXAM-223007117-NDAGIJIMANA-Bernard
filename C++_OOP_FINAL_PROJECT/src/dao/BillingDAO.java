...
public class BillingDAO {
    ...
    public int add(Billing b) {
        ...
        try (Connection c = DBConnection.getConnection(); PreparedStatement ps = c.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            if (b.getPatientID() == null) ps.setNull(1, Types.INTEGER); else ps.setInt(1, b.getPatientID());
            ps.setString(2, b.getPatientName());
            ps.setDouble(3, b.getAmount());
            ps.setString(4, b.getPaymentMethod());
            if (b.getMedicalRecordID() == null) ps.setNull(5, Types.INTEGER); else ps.setInt(5, b.getMedicalRecordID());
            ps.executeUpdate();
